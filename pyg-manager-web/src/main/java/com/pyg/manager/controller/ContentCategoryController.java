...
public class ContentCategoryController {
     ...
     */
	@RequestMapping("/add")
	public InfoResult add(@RequestBody TbContentCategory contentCategory){
		try {
	...
	public InfoResult update(@RequestBody TbContentCategory contentCategory){
		try {
	...
	public PageResult search(@PathVariable Integer page, @PathVariable Integer rows, @RequestBody TbContentCategory contentCategory){
