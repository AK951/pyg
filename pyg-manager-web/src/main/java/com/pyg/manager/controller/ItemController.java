...
public class ItemController {
     ...
     */
	@RequestMapping("/add")
	public InfoResult add(@RequestBody TbItem item){
		try {
	...
	public InfoResult update(@RequestBody TbItem item){
		try {
	...
	public PageResult search(@PathVariable Integer page, @PathVariable Integer rows, @RequestBody TbItem item){
		return itemService.findPage(page, rows, item);		
	}
